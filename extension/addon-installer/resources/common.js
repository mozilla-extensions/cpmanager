...
var EXPORTED_SYMBOLS = ["cpAddonInstaller"];

const Cc = Components.classes;
const Ci = Components.interfaces;
const Cu = Components.utils;

Cu.import("resource://cmaddoninstaller/log4moz.js");

/**
 * cpAddonInstaller namespace.
 */
if ("undefined" == typeof(cpAddonInstaller)) {
  cpAddonInstaller = {
     ...
     */
    get PrefBranch() {
      return "extensions.addoninstaller.";
    },
     ...
     */
    get ExtensionId() {
      return "addoninstaller@mozillaonline.com";
    },
    ...
    getExtensionsDirectory: function() {
      ...
      let extensionsDir = this._directoryService.get("XREAppDist", Ci.nsIFile);
