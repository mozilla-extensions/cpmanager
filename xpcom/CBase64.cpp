...
int CBase64::Decode(const PBYTE pBuffer, DWORD dwBufLen)
{
if(!CBase64::m_Init)
  _Init();
...
int CBase64::Decode(LPCSTR szMessage)
{
if(szMessage != NULL)
  return CBase64::Decode((const PBYTE)szMessage, lstrlenA(szMessage));
return 0;
}
